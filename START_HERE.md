...
3. **Stop**: Tap "STOP RECORDING"
   - File saved to: `/Android/data/com.fmea.highfps/files/output_*.mp4`
---
## **VERIFY OUTPUT**
On your computer:
```bash
# Download video
adb pull /storage/emulated/0/Android/data/com.fmea.highfps/files/ ~/Downloads/
# Check FPS
...
adb uninstall com.fmea.highfps  # Remove
```
---
## **BEFORE YOU START**
Make sure you have:
