...
- **App-Specific Storage**: Saves output MP4 under `/Android/data/com.fmea.highfps/files/`.
...
```
/storage/emulated/0/Android/data/com.fmea.highfps/files/output_YYYYMMDD_HHMMSS_240fps.mp4
```
...
mkdir -p out
javac -d out app/src/main/java/com/fmea/highfps/FpsSelector.java app/src/test/java/com/fmea/highfps/FpsSelectorHarness.java
java -cp out com.fmea.highfps.FpsSelectorHarness
```
...
### Activity & Core Logic
- `app/src/main/java/com/fmea/highfps/MainActivity.java` — Main app entry; camera setup, recording control, permissions.
- `app/src/main/java/com/fmea/highfps/FpsSelector.java` — FPS range selection utility (query-side logic).

### UI & Preview
- `app/src/main/java/com/fmea/highfps/CameraPreviewView.java` — TextureView-based camera preview.
- `app/src/main/java/com/fmea/highfps/PreviewCallback.java` — Interface for preview readiness signals.

### Utilities
- `app/src/main/java/com/fmea/highfps/CameraInfoFormatter.java` — Formats camera capabilities for display.
...
### Tests
- `app/src/test/java/com/fmea/highfps/FpsSelectorTest.java` — JUnit unit tests for FPS logic.
- `app/src/test/java/com/fmea/highfps/FpsSelectorHarness.java` — Standalone Java harness (no Android deps).
...
│   │   └── AndroidManifest.xml
│   ├── src/test/java/com/fmea/highfps/
...
```
/Android/media/com.fmea.highfps/files/frames/session_YYYYMMDD_HHMMSS/
```
