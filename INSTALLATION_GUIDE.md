...
adb uninstall com.fmea.highfps
...
**Path Format:**
```
/storage/emulated/0/Android/data/com.fmea.highfps/files/session_YYYYMMDD_HHMMSS/
```

**Example:**
```
/storage/emulated/0/Android/data/com.fmea.highfps/files/session_20260306_173045/
...
2. Navigate to: `Internal Storage` → `Android` → `data` → `com.fmea.highfps` → `files`
...
adb pull /storage/emulated/0/Android/data/com.fmea.highfps/files/session_20260306_173045 ~/Downloads/
...
```bash
# Clear old data
adb shell pm clear com.fmea.highfps
...
# Check folder exists
adb shell ls -la /storage/emulated/0/Android/data/com.fmea.highfps/files/
```
...
```bash
# Count frames
adb shell ls /storage/emulated/0/Android/data/com.fmea.highfps/files/session_*/frame_*.tiff | wc -l

# Check timestamps (should be ~4ms apart for 240fps)
adb shell ls -l /storage/emulated/0/Android/data/com.fmea.highfps/files/session_*/frame_*.tiff | head -20
```
