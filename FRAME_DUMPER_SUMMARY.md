...
- App-specific folder: `/Android/data/com.fmea.highfps/files/frames/`
...
├── app/src/main/java/com/fmea/highfps/
...
### **Step 4: Retrieve**
```bash
adb pull /storage/emulated/0/Android/data/com.fmea.highfps/files/frames/ ~/Downloads/
```
### **Step 5: Verify**
```bash
