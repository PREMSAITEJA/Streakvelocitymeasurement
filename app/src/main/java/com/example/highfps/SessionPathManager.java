 ...
 *   Android/media/com.example.highfps/Media/<sessionName>/
 ...
 *       results/        -> final BLE graphs, streak vector flow video + individual
 *                           images (named after the source frames), ready to download
 *
