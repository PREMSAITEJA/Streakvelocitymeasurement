...
| **Storage** | App-specific external storage (`/Android/data/com.fmea.highfps/files/frames/`) |
...
adb shell am start -n com.fmea.highfps/.MainActivity
```
...
Toast shows:
  ...
  - Output folder: /Android/data/com.fmea.highfps/files/frames/
...
adb pull /storage/emulated/0/Android/data/com.fmea.highfps/files/frames/ ~/Downloads/frames/
...
adb shell ls -la /sdcard/Android/data/com.fmea.highfps/files/frames/

# 2. Frame count matches logged value
adb shell find /sdcard/Android/data/com.fmea.highfps/files/frames/ -name "*.tiff" | wc -l

# 3. Frames are sequential
adb shell ls -1 /sdcard/Android/data/com.fmea.highfps/files/frames/ | head -5

# 4. File sizes are consistent (~2.2 MB each)
adb shell ls -lh /sdcard/Android/data/com.fmea.highfps/files/frames/ | head -5

# 5. Timestamps increment correctly (~4.17ms apart)
adb shell ls -1 /sdcard/Android/data/com.fmea.highfps/files/frames/ | tail -1
```
...
# Download frames
adb pull /storage/emulated/0/Android/data/com.fmea.highfps/files/frames/ ./
```
